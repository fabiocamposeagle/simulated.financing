function simular() {
  ...
  for (var i = 0; i < prestacoes; i++) {
    ...
    if (i < 5) {
      ...
      tr.children[1].textContent = " R$ " + amortizacao.toFixed(2);
      tr.children[2].textContent = " R$ " + jurosPrestacao.toFixed(2);
      tr.children[3].textContent = " R$ " + totalPrestacao.toFixed(2);
    }
  }
